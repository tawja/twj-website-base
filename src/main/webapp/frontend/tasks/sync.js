module.exports = {
    ...
    lib: {
        files: [{
                ...
                src: ['./*.js'],
                dest: '<%= gruntMavenProperties.targetPath %>/<%= config.webapp %>/<%= config.assets %>/<%= config.lib %>/less'
            }, {
                expand: true,
                cwd: '<%= config.bower_components %>/classie',
                src: ['./*.js'],
                dest: '<%= gruntMavenProperties.targetPath %>/<%= config.webapp %>/<%= config.assets %>/<%= config.lib %>/classie'
            }]
    },
    override: {
        files: [{
